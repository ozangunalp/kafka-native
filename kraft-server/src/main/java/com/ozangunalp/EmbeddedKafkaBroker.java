...
public class EmbeddedKafkaBroker implements Closeable {
    ...
    public static KafkaConfig formatStorageFromConfig(Properties properties, String clusterId, boolean ignoreFormatted) {
        ...
        StorageTool.formatCommand(LoggingOutputStream.loggerPrintStream(LOGGER), directories, metaProperties, MINIMUM_BOOTSTRAP_VERSION,
                ignoreFormatted);
        return config;
    }
    ...
    public static void formatStorage(List<String> directories, String clusterId, int nodeId, boolean ignoreFormatted) {
        ...
        StorageTool.formatCommand(LoggingOutputStream.loggerPrintStream(LOGGER), dirs, metaProperties, MINIMUM_BOOTSTRAP_VERSION, ignoreFormatted);
    }
